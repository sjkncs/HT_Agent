...
public class LLMServiceImpl implements LLMService {
    ...
    private void buildOrderingPrompt(StringBuilder sb, String subScenario, String userMessage) {
        ...
        sb.append("- 确认饮品名称、规格（糖度/加料/杯型）和数量\n");
        sb.append("- 查询门店地址和配送范围\n");
        sb.append("- 确认订单、模拟下单流程\n\n");

        sb.append("【产品分类 — 5大类】\n");
        sb.append("1. 茶特调/茗茶 — 芝芝系列、纯茶、冰饮特调\n");
        sb.append("2. 植物茶/鲜果茶 — 多肉葡萄、满杯红柚、爆汁杨梅等鲜果茶、纤体瓶\n");
        sb.append("3. 苦巧/抹茶/波波茶 — 波波牛乳茶、抹茶系列、巧克力系列、糯糯系列\n");
        sb.append("4. 灵感茶点 — 芒椰糯米饭等甜品\n");
        sb.append("5. 咖啡/经典/小料 — 小奶茉、经典茶饮、轻饮\n\n");

        sb.append("【点单定制选项 — 与小程序一致】\n");
        sb.append("- 通用糖度（单选）：全糖、七分糖、五分糖、三分糖、无糖\n");
        sb.append("- 通用加料（可多选）：芝士+¥3、椰果+¥2、珍珠+¥2、芋圆+¥3、红薏+¥2、芦荟+¥2\n");
        sb.append("- 通用杯型（单选）：中杯、大杯+¥3\n");
        sb.append("- 备注：如少冰、去冰、加糖等特殊需求\n");
        sb.append("- 产品专属定制：部分产品有专属甜度/冰量/做法选项，如芒椰糯米饭的「纯料真冰糖/真0卡糖/低GI」\n");
